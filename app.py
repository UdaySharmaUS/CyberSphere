...
if menu == "Threat Detection":
    ...
    if st.session_state['data'] is not None:
        ...
        plt.title('Anomaly Scores Distribution', fontsize=18, fontweight='bold', color='#213555')
        plt.xlabel('Anomaly Score', fontsize=14, fontweight='bold', color='#213555')
        plt.ylabel('Frequency', fontsize=14, fontweight='bold', color='#213555')
